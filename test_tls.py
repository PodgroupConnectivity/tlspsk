...
def main():
    ...
    # server = '63.34.4.88'
    server = '34.253.244.76'  #'52.213.234.222'
    port = 11111
    # server = "127.0.0.1"
    # port = 443
    ...
    # data_string = '{"iccid":"984405529081369836f5",' + \
    #               '"imei":"3a75250047633502",' + \
    #               '"tp":"ffffffff7f9d00ffbf03021fe200000083eb0000001c4800100000000008"}'

    # data = bytes('POST /v1/data/51523143572089723526?iccid=984405529081369836f5 HTTP/1.1\x0d\x0a' +
    data = bytes('POST /v1/data/51523143572089723527?iccid={0} HTTP/1.1\x0d\x0a'.format(iccid.hex()) +
    # data = bytes('POST /v1/tp/ HTTP/1.1\x0d\x0a' +
